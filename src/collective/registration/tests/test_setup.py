...
class TestSetup(unittest.TestCase):
    ...
    def test_product_installed(self):
        ...
        self.assertTrue(self.installer.isProductInstalled("collective.registration"))

    def test_browserlayer(self):
        """Test that ICollectiveRegistrationLayer is registered."""
        from collective.registration.interfaces import ICollectiveRegistrationLayer
        from plone.browserlayer import utils

        self.assertIn(ICollectiveRegistrationLayer, utils.registered_layers())
...
class TestUninstall(unittest.TestCase):
    ...
    def test_product_uninstalled(self):
        ...
        self.assertFalse(self.installer.isProductInstalled("collective.registration"))
    ...
    def test_browserlayer_removed(self):
        ...
        self.assertNotIn(ICollectiveRegistrationLayer, utils.registered_layers())
